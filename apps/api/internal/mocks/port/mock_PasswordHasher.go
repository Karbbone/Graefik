...
func (_mock *MockPasswordHasher) Compare(hash string, password string) error {
...
//   - hash string
//   - password string
func (_e *MockPasswordHasher_Expecter) Compare(hash any, password any) *MockPasswordHasher_Compare_Call {
...
func (_c *MockPasswordHasher_Compare_Call) RunAndReturn(run func(hash string, password string) error) *MockPasswordHasher_Compare_Call {
	_c.Call.Return(run)
	return _c
}
