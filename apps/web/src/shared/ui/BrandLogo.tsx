...
export function BrandLogo({ size = 48, className = '' }: Props) {
  ...
  return (
    <svg
      ...
      style={{ width: size, height: size }}
    >
      <rect x="6" y="6" width="88" height="88" rx="26" fill="var(--color-gfteal)" />
      <rect
        x="6"
        y="6"
        width="88"
      ...
      />
      {/* lunettes */}
      <circle cx="37" cy="45" r="15" fill="var(--color-gfcream)" stroke="var(--color-gfink)" strokeWidth="5" />
      <circle cx="70" cy="45" r="13" fill="var(--color-gfcream)" stroke="var(--color-gfink)" strokeWidth="5" />
      <line x1="51" y1="44" x2="58" y2="44" stroke="var(--color-gfink)" strokeWidth="5" />
      {/* yeux */}
